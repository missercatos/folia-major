...
export default {
  ...
  "commandPalette": {
    ...
    "pickerDescription": {
      "visualizer": {
        ...
        "hypr": "Hyprland-inspired tiling layout with glass effects, blur, and dynamic border glow"
      },
      "background": {
  ...
  "options": {
    ...
    "hyprSettings": "Hypr Settings",
    "hyprSettingsDesc": "Control tiling layout mode, master factor, gaps, rounding, border size, inactive dim, glass opacity, blur strength, border spin speed, transition speed, and cover window visibility.",
    "hyprLayoutMode": "Layout Mode",
    "hyprLayoutDwindle": "Dwindle",
    "hyprLayoutMaster": "Master",
    "hyprLayoutMonocle": "Monocle",
    "hyprMfact": "Master Factor",
    "hyprGapsInner": "Inner Gaps",
    "hyprGapsOuter": "Outer Gaps",
    "hyprRounding": "Rounding",
    "hyprBorderSize": "Border Size",
    "hyprInactiveDim": "Inactive Dim",
    "hyprGlassOpacity": "Glass Opacity",
    "hyprBlurStrength": "Blur Strength",
    "hyprBorderSpinSpeed": "Border Spin Speed",
    "hyprTransitionSpeed": "Transition Speed",
    "hyprShowPastCount": "Show Past Lines",
    "hyprShowUpcomingCount": "Show Upcoming Lines",
    "hyprShowCoverWindow": "Show Cover Window",
    "hyprAudioGlow": "Audio Glow",
