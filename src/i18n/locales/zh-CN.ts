...
export default {
  ...
  "commandPalette": {
    ...
    "pickerDescription": {
      "visualizer": {
        ...
        "hypr": "Hyprland 风格平铺布局，搭配玻璃效果、模糊与动态边框辉光"
      },
      "background": {
    ...
    "commands": {
      ...
      "visualizer-hypr": { "title": "切换到可视化：叠窗", "description": "切换至叠窗平铺视觉" },
  ...
  "options": {
    ...
    "hyprSettings": "叠窗参数",
    "hyprSettingsDesc": "调整平铺布局模式、主人因子、内外间距、圆角、边框宽度、未激活暗化、玻璃透明度、模糊强度、边框旋转速度、过渡速度与封面窗口显示。",
    "hyprLayoutMode": "布局模式",
    ...
    "hyprRounding": "圆角",
    "hyprBorderSize": "边框宽度",
    "hyprInactiveDim": "未激活暗化",
    "hyprGlassOpacity": "玻璃透明度",
    "hyprBlurStrength": "模糊强度",
    "hyprBorderSpinSpeed": "边框旋转速度",
    "hyprTransitionSpeed": "过渡速度",
    "hyprShowPastCount": "已唱行数",
    "hyprShowUpcomingCount": "即将唱行数",
    "hyprShowCoverWindow": "显示封面窗口",
    "hyprAudioGlow": "音频辉光",
    "sonnetSettings": "商籁参数",
